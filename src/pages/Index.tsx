...
const Index = () => {
  ...
  const projects = [
    ...
    {
      id: 8,
      title: 'Гаражный комплекс с металлоконструкциями',
      type: 'warehouse',
      area: '900 м²',
      duration: '5 месяцев',
      image: 'https://cdn.poehali.dev/files/f3bd86af-a091-4d70-8ce6-de15117788a6.png',
      description: 'Ряд гаражных боксов с профнастила и металлокаркасом',
      technologies: ['Профнастил', 'Металлокаркас', 'Секционные ворота'],
      client: 'ООО "ГаражСтрой"',
      review: 'Построили качественно, каждый бокс с отдельным въездом. Отлично!'
    },
    {
      id: 9,
      title: 'Внутренняя отделка жилого дома',
      type: 'residential',
      area: '150 м²',
      duration: '4 месяца',
      image: 'https://cdn.poehali.dev/files/d933d8fe-fb78-4d02-899b-d0a71a87bd79.jpg',
      description: 'Черновая отделка: укладка полов, подготовка стен и потолков',
      technologies: ['Деревянные лаги', 'Утеплитель', 'Отопление'],
      client: 'Семья Кузнецовых',
      review: 'Сделали всё аккуратно, готовы к чистовой отделке. Спасибо!'
    },
    {
      id: 10,
      title: 'Производственный цех с высокими потолками',
      type: 'warehouse',
      area: '2,100 м²',
      duration: '9 месяцев',
      image: 'https://cdn.poehali.dev/files/1de9dafb-ce5b-4be2-bb15-e07db4d09034.jpg',
      description: 'Промышленный цех с металлокаркасом и панорамным остеклением',
      technologies: ['Металлокаркас', 'Сэндвич-панели', 'Армированный пол'],
      client: 'АО "ПромСтрой"',
      review: 'Выполнили в срок, отличная вентиляция и освещение. Рады работать с вами!'
    },
    {
      id: 11,
      title: 'Модульное здание из профлиста',
      type: 'commercial',
      area: '320 м²',
      duration: '3 месяца',
      image: 'https://cdn.poehali.dev/files/d4814383-ea22-455e-a7c1-e0161a63691c.jpg',
      description: 'Быстровозводимое коммерческое здание с окнами',
      technologies: ['Профлист', 'Металлокаркас', 'Энергосберегающие окна'],
      client: 'ООО "БизнесЦентр"',
      review: 'Построили очень быстро! Качество на высоте, всё по проекту.'
    }
  ];
